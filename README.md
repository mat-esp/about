...
| 4     | Python: Jupyter notebook, programas simples e numpy | [Projeto Jupyter](http://jupyter.org/), [Lição de numpy no Scipy Lecture Notes](http://www.scipy-lectures.org/), [Lições de Python v5.3 do Software Carpentry](http://software-carpentry.org) | [python-intro-2](https://github.com/leouieda/mat-esp-python-intro-2) |
