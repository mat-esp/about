...
partir do dia 10/09/2015~~ **6134F** a partir do dia 16/09/2015.
...
| 3     | Python: variáveis, loops e condições  | [Lições de Python do Software Carpentry](http://software-carpentry.org/lessons.html), [Tutorial matplotlib](http://scipy-lectures.github.io/intro/matplotlib/matplotlib.html), [Galeria matplotlib](http://matplotlib.org/gallery.html)    | [python-intro](https://github.com/leouieda/mat-esp-python-intro-2015) |
| 4     | Python: estruturação de um programa e funções |    | |
| 5     | Python: arrays, numpy e gráficos simples |    | |
